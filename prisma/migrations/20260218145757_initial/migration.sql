...
CREATE TABLE "FocusSession" (
    ...
    "yawnCount" INTEGER NOT NULL DEFAULT 0,
    "lookAwayCount" INTEGER NOT NULL DEFAULT 0,
    "distractionTime" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "FocusMetric" (
    ...
    "isBlinking" BOOLEAN NOT NULL DEFAULT false,
    "isYawning" BOOLEAN NOT NULL DEFAULT false,
    "isLookingAway" BOOLEAN NOT NULL DEFAULT false,
    "headRotationX" DOUBLE PRECISION,
    "headRotationY" DOUBLE PRECISION,
    "headRotationZ" DOUBLE PRECISION,
    "focusLevel" INTEGER NOT NULL DEFAULT 100,
...
-- AddForeignKey
ALTER TABLE "FocusMetric" ADD CONSTRAINT "FocusMetric_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "FocusSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
